...
One of the more common mistakes I see new DevOps practitioners make is that put all of their infrastructure declarations for **CX as Code** as one or two big Terraform projects, all managed from a single source-control repository. This is problematic for two reasons:
