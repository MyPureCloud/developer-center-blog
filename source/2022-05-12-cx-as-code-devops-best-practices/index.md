...
Decompose your CX infrastructure down into small deployable units of work that mirror the natural communication structure of your organization. This is often referred to an [Conway's law](https://en.wikipedia.org/wiki/Conway%27s_law). This means that if you multiple Lines of Business (LOB) or functional areas working on a system, the software components they are building should mirror the the organizational structure with each group having separate repositories and code deployment pipelines rather then a single monolithic repository.
...
1. [Install CX as Code](https://developer.genesys.cloud/api/rest/CX-as-Code/). General Instructions for installing Terraform.
...
3. [Introducing CX as Code](https://developer.genesys.cloud/blog/2021-04-16-cx-as-code/) Blog Post. 
