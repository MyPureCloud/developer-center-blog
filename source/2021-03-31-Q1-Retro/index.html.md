...
|[Introducing the Genesys Cloud CLI](/2021-02-11-Introducing-the-CLI/)|Blog|A brief, high-level introduction to the new Genesys Cloud CLI. It is a great starting point for finding all the content associated with the new CLI.| 
...
|[Collecting and using customer information with web chat widget version 2](/blog/2021-03-08-accessing-collected-chat-v2-information/)|Blog|Jerome Saint Marc, one of our Senior Developer Evangelists, walks through how to collect custom attributes and customer information via WebChat.|
...
|[The Genesys Cloud CLI: A Deep Dive](https://www.youtube.com/watch?v=rb2xqZU5vNc)|DevCast|John Carnell does a detailed walkthrough of the Genesys Cloud CLI, its architecture, philosophy and capabilities.| 
|[Update a Genesys Cloud Do Not Contact list with the Genesys Cloud for Salesforce SDK](/blueprints/genesys-cloud-for-salesforce-sdk-dnclist-example/)|Blueprint|This blueprint demonstrates how add the primary phone number from Salesforce to a Genesys Cloud "Do not call" list.|
...
1. __More content__. This one is a given. We are committed to continually building out new content. In our content pipeline for this next quarter, we have new Developer Starting guides for integrating with the Genesys Cloud UI, a new Developer Starting guide for building Resilient Cloud integrations, and a new blueprint showing how to take the Genesys Cloud conversation model and map it to a relational database table. 
