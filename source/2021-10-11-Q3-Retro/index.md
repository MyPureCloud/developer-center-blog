...
The Developer Engagement team has been roaring through this year and I am excited and proud to see the content and capabilities being produced by this team. I am also ecstatic with the developer community we continue to build out. Many of the features and content we build come directly from our day-to-day interactions with you. Please keep the feedback coming,use the [developer forum](https://developer.genesys.cloud/forum/), and let's build something great together.
