...
And image here describes the basic flow through the notification service as we process messages with the **Factory Pattern** and the **Command Pattern**.
...
`./command_implementation/routing_queues_id_users.go`
