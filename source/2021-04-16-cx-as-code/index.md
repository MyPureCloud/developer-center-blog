...
1. Downloads terraform, unzips it and then installs it `/usr/local/bin` on the VM. 
2. Downloads the latest copy of the Genesys Cloud CLI [8](/api/rest/command-line-interface/)] It also installs the latest copy of the Genesys.
