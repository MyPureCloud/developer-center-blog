...
This model can be leveraged in backend services to build near-time data integrations, particularly if using AWS in your organization is not possible.  However, as a developer you need to be aware of the following when using this model:
